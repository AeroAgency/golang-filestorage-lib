...
func (m *MinioFileStorage) GetFile(bucketName string, fileName string) (io.Reader, error) {
	res, err := m.client.GetObject(bucketName, fileName, minio.GetObjectOptions{})
	if err != nil {
		return nil, err
	}
	return res, nil
